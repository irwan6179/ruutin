/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 2b1ae7fb6be8a0071d17221d3363dcee)
// Runtime types generated with workerd@1.20260515.1 2026-09-09 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	EMAIL_API_URL: "https://api.resend.com/emails";
	EMAIL_FROM: "noreply@ruutin.irwan.cc";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_API_URL" | "EMAIL_FROM" | "EMAIL_API_KEY" | "AUTH_HMAC_SECRET" | "SESSION_SECRET">> {}
}
