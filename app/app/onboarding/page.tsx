...
export default async function OnboardingPage() {
  ...
  if (!parent) return <OnboardingFlow initialState={deriveOnboardingState({ hasHousehold: false, profileCount: 0, taskCount: 0 })} initialHousehold={null} initialProfiles={[]} />;
  const db = getD1();
