  ...
  return (
    <div className="ruutin-page-stack">
      ...
      <section className="ruutin-card ruutin-settings-panel" aria-labelledby="privacy-title">
        ...
        <p className="ruutin-settings-copy">Ruutin keeps household routines, broad age bands, nicknames, emoji, progress, linked-device labels, and a small set of first-party experience signals such as opening Today or finishing setup. Those coarse signals help us understand whether the family loop is becoming easier; they contain no free-form child content and leave with the household. Companion access is parent-managed, and profiles marked under 13 stay parent-only. We do not need a child’s full name, exact birthday, contacts, or precise location.</p>
        <div className="ruutin-settings-export"><div><strong>Download your household data</strong><p>JSON includes your household routines, profiles, claims, rewards, ledger history, safe linked-device metadata, and coarse experience signals. It never includes passwords, TACs, session tokens, pairing secrets, or hashes.</p></div><button className="ruutin-button secondary" type="button" onClick={downloadExport} disabled={exporting}>{exporting ? "Preparing…" : "Download JSON"}</button></div>
      ...
      <section className="ruutin-card ruutin-settings-panel ruutin-settings-danger" aria-labelledby="delete-title">
        ...
        <p className="ruutin-settings-copy">This permanently deletes <strong>{initialSettings.household.name}</strong>, including profiles, tasks, claims, rewards, requests, star history, experience signals, and linked-device records. It cannot be undone. Parent and companion access is revoked when deletion completes.</p>
